...
Elm.Gif = Elm.Gif || {};
Elm.Gif.make = function (_elm) {
   "use strict";
   _elm.Gif = _elm.Gif || {};
   if (_elm.Gif.values) return _elm.Gif.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Array = Elm.Array.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
...
Elm.GifLab.make = function (_elm) {
   "use strict";
   _elm.GifLab = _elm.GifLab || {};
   if (_elm.GifLab.values) return _elm.GifLab.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Array = Elm.Array.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   $Gif = Elm.Gif.make(_elm),
   $Graphics$Collage = Elm.Graphics.Collage.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   var viewFrameInDimensions = F3(function (width,height,_p0) {
      var _p1 = _p0;
      return A2($Html.div,_U.list([]),_U.list([$Html.fromElement(A3($Graphics$Collage.collage,width,height,_p1._0))]));
   });
   var viewIndividualFrames = function (model) {
      return A2($Html.div,
...
Elm.Sandbox = Elm.Sandbox || {};
Elm.Sandbox.make = function (_elm) {
   "use strict";
   _elm.Sandbox = _elm.Sandbox || {};
   if (_elm.Sandbox.values) return _elm.Sandbox.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Color = Elm.Color.make(_elm),
   $Debug = Elm.Debug.make(_elm),
